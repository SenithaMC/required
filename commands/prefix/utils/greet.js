  ...
  async execute(message, args) {
    ...
    if (args[0].toLowerCase() === 'disable') {
      ...
      const embed = new EmbedBuilder()
        ...
        .setTitle(wasEnabled ? '<:mc_white_check_mark:1410629081845989386> Greet Disabled' : 'ℹ️ Greet Already Disabled')
    ...
    if (!channel) {
      const embed = new EmbedBuilder()
        .setColor(0xFF0000)
        .setTitle('<:mc_white_cross:1411727598840451174> Channel Not Found')
    ...
    if (channel.type !== 0) {
      const embed = new EmbedBuilder()
        .setColor(0xFF0000)
        .setTitle('<:mc_white_cross:1411727598840451174> Invalid Channel Type')
    ...
    if (remainingArgs.length < 2) {
      const embed = new EmbedBuilder()
        .setColor(0xFF0000)
        .setTitle('<:mc_white_cross:1411727598840451174> Invalid Usage')
    ...
    if (isNaN(deleteAfter) || deleteAfter < 0) {
      const embed = new EmbedBuilder()
        .setColor(0xFF0000)
        .setTitle('<:mc_white_cross:1411727598840451174> Invalid Time')
    ...
    if (missingPerms.length > 0) {
      ...
      const embed = new EmbedBuilder()
        .setColor(0xFF0000)
        .setTitle('<:mc_white_cross:1411727598840451174> Missing Permissions')
    ...
    const embed = new EmbedBuilder()
      .setColor(0x00FF00)
      .setTitle('<:mc_white_check_mark:1410629081845989386> Greet Configuration Set')
